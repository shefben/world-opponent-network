...
protected:
	...
	std::string		mVersionTo;
	std::string		mVersionToDescriptionURL;
...
public:
	...
	const std::string& GetToVersion()			{ return mVersionTo; }
	const std::string& GetToVersionDescriptionURL() { return mVersionToDescriptionURL; }
