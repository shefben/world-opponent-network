...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
bool AsyncSocket::HasInternetConnection()
{
#ifdef WIN32_NOT_XBOX
	typedef BOOL (WINAPI *InternetGetConnectedStateFunc)(OUT LPDWORD  lpdwFlags,IN DWORD    dwReserved);
	static InternetGetConnectedStateFunc anInternetGetConnectedStateFunc = NULL;
	...
	if(!haveLoaded)
	{
		HMODULE aModule = LoadLibrary("wininet.dll");
		if(aModule!=NULL)
		{
			anUnload.mModule = aModule;
			anInternetGetConnectedStateFunc  = (InternetGetConnectedStateFunc)GetProcAddress(aModule,"InternetGetConnectedState");
		}

		haveLoaded = true;	
	}

	if(anInternetGetConnectedStateFunc!=NULL)
	{
		DWORD aFlags = 0;
		return anInternetGetConnectedStateFunc(&aFlags,0)==TRUE;
	}
	else
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
WONStatus AsyncSocket::SetAllowBroadcast(bool allowBroadcast)
{
	int aVal, aSockOpt = allowBroadcast;
	aVal = setsockopt(mSocket,SOL_SOCKET,SO_BROADCAST,(char*)&aSockOpt,sizeof(aSockOpt));
...
WONStatus AsyncSocket::GetNewDescriptor() 
{
	...
	mLastError = WS_None; // reset socket error
...
WONStatus AsyncSocket::Bind(unsigned short thePort, bool allowReuse) 
{
	...
	aSockAddrIn.sin_addr.s_addr = htonl(IPAddr::GetLocalHost());
