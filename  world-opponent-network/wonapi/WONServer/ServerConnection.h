...
public:
	...
	PeerAuthOp* ConnectAsync(const IPAddr &theAddr, DWORD theTimeout = OP_TIMEOUT_INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
class ServerConnectionConnectOp : public AsyncOp
{
protected:
	static void StaticConnectCompletion(AsyncOpPtr theOp, RefCountPtr that);
	void ConnectCompletion(AsyncOp *theOp);
...
public:
	ServerConnectionConnectOp(ServerConnection *theConnection, const IPAddr &theAddr);
};
typedef SmartPtr<ServerConnectionConnectOp> ServerConnectionConnectOpPtr;
