...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void AuthContext::RemoveAllCommunity()
{
	AutoCrit aCrit(mDataCrit);
	mCommunityMap.clear();
}
...
void AuthContext::AppendCommunityData(WriteBuffer &theBuf)
{
	...
	if(!mProductVersion.empty())
	{
		theBuf.AppendByte(9); // Product version
		theBuf.AppendShort(mProductVersion.length()+2);
		theBuf.AppendString(mProductVersion);
		aNumCommunityElements++;
	}
