...
namespace
{
	...
	const unsigned char FORCE_MASK     = 0x80;
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
DWORD CDKey::GetMachineId(bool *success) // get unique machine id for encrypting
{
	if(success!=NULL)
		*success = true;
...
void CDKey::GetSymmetricKey(Blowfish &theSymKey, bool useNewMethod) const
{
	...
	{
		bool gotId;
		DWORD anId = GetMachineId(&gotId);
		if(gotId)
			aBuf.append((const unsigned char*)(&anId),4);
	}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
bool CDKey::InitRaw(const void* theRawKey)
{
	mIsValid = false;
	mKey = NULL;
	return CalcKeyFromBuffer((const char*)theRawKey);
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
bool CDKey::IsForceCheck() const
{
	if(mKey->length()<3)
		return false;
	else
		return ((mKey->data())[2] & FORCE_MASK ? true : false);
}
