...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CDKey::GetSymmetricKey(Blowfish &theSymKey) const
{
	CRC16     aCRC;
	RawBuffer aBuf;
...
bool CDKey::InitEncrypted(const void *theEncryptedKey, unsigned long theEncryptLen)
{
	...
	return CalcKeyFromBuffer(aDecrypt->data());
}


///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static const char* CDKEY_REG_PATH = "SOFTWARE\\WON\\CDKeys";

bool CDKey::SaveToRegistry(RegKeyRoot theRoot) // stores under SOFTWARE\WON\CDKeys\<Product>
{
	if(!IsValid())
		return false;

	RegKey aKey(theRoot, CDKEY_REG_PATH, true);
	if(!aKey.IsOpen())
		return false;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
bool CDKey::LoadFromRegistry(RegKeyRoot theRoot)
{
	if(mProduct.empty())
		return false;

	RegKey aKey(theRoot, CDKEY_REG_PATH);
	if(!aKey.IsOpen())
		return false;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CDKey::ClearFromRegistry(RegKeyRoot theRoot)
{
	if(mProduct.empty())
		return;
