...
enum RoutingClientFlags
{
	...
	RoutingClientFlag_IsAdmin							= 0x0020,
	RoutingClientFlag_IsAnonymous						= 0x0040 // don't report friend location
...
enum RoutingChatFlags
{
	...
	RoutingChatFlag_IsWarning								= 0x0010
};
...
enum RoutingRegisterClientFlags
{
	...
	RoutingRegisterClientFlag_GetClientListEx				= 0x0014
};
...
enum RoutingGetGroupListFlags
{
	...
	RoutingGetGroupList_IncludeClientCount					= 0x0100,
...
struct RoutingClientInfo : public RefCount
{
	...
	RoutingClientInfo() : mId(0), mFlags(0), mWONUserId(0), mCDKeyId(0), mTrustLevel(0) {}
};
...
enum RoutingMsgTypes
{
	...
	RoutingIsUserPresentRequest			=72,
	RoutingIsUserPresentReply			=73,
	RoutingGetClientListReplyEx			=74,
