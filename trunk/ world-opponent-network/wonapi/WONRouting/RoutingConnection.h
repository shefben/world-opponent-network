...
///////////////////////////////////
	...
	void GetClientListEx(OpCompletionBase *theCompletion = NULL);
	...
	void BanClientByCDKeyId(unsigned short theGroupId, bool isBanned, unsigned long theSeconds, 
		const std::wstring &theComment, unsigned long theCDKeyId, OpCompletionBase *theCompletion = NULL);
	...
	void MuteClientByCDKeyId(unsigned short theGroupId, bool isMuted, unsigned long theSeconds, 
		const std::wstring &theComment, unsigned long theCDKeyId, OpCompletionBase *theCompletion = NULL);
