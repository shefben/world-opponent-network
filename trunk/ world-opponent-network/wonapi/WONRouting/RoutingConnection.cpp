...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void RoutingConnection::GetClientListEx(OpCompletionBase *theCompletion)
{
	RoutingGetClientListOpPtr anOp = new RoutingGetClientListOp(this,true);
	anOp->SetCompletion(theCompletion);
	anOp->Run();	
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void RoutingConnection::BanClientByCDKeyId(unsigned short theGroupId, bool isBanned, unsigned long theSeconds, 
	const std::wstring &theComment, unsigned long theCDKeyId, OpCompletionBase *theCompletion)
{
	RoutingBanClientOpPtr anOp = new RoutingBanClientOp(this);
	anOp->SetGroupId(theGroupId);
	anOp->SetIsBanned(isBanned);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void RoutingConnection::MuteClientByCDKeyId(unsigned short theGroupId, bool isMuted, unsigned long theSeconds, 
	const std::wstring &theComment, unsigned long theCDKeyId, OpCompletionBase *theCompletion)
{
	RoutingMuteClientOpPtr anOp = new RoutingMuteClientOp(this);
	anOp->SetGroupId(theGroupId);
