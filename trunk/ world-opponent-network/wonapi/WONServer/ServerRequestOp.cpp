...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
ServerRequestOp::~ServerRequestOp()
{
}
...
bool ServerRequestOp::TryPeerToPeerAuth()
{
	...
	aPeerAuthOp->SetClientKeySize(mClientKeySize, mUseClientKey);
	if(IsAsync())
	{
...
void ServerRequestOp::CleanupHook()
{
	...
	if(!Succeeded() && (TimedOut() || Killed()) && mServerContext.get()!=NULL)
		mServerContext->NotifyFailed(mCurAddr);

	if(mSocket.get()!=NULL && (mCloseConnection || !SucceededAlive()))
	{
		mSocket->Close();
		mSocket = NULL;
	}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
ServerConnectOp::ServerConnectOp(ServerContext *theContext) : ServerRequestOp(theContext) 
{
	Init();	
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
ServerConnectOp::ServerConnectOp(const IPAddr &theAddr) : ServerRequestOp(theAddr)
{
	Init();	
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
WONStatus ServerConnectOp::GetNextRequest()
{
	if(mHaveSent)
		return WS_Success;

	if(!mSendData && !mSendNoOp)
		return WS_Success;

	if(mSendNoOp)
	{
		WriteBuffer aMsg(mLengthFieldSize);
		aMsg.AppendByte(3);						// Mini
		aMsg.AppendByte(1);					// Common
		aMsg.AppendByte(7);					// No Op
