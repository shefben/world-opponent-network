...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
CheckValidVersionOp::~CheckValidVersionOp() // Safety Lock -- Enforces Smart Ptr Use
{
}			
...
WONStatus CheckValidVersionOp::CheckResponse()
{
	...
	std::string aVersion;
	std::string aDescrpURL;

	readBuf.ReadString(mVersionTo);
	readBuf.ReadString(mVersionToDescriptionURL);
	...
	for (int patchNum=0; patchNum<numPatches; ++patchNum)
	{
		...
		thePatchData->SetFromVersion(GetVersion());
		thePatchData->SetToVersion(mVersionTo);
...
void CheckValidVersionOp::Init()
{
	...
	mVersionData->SetState(VersionState_BadState);

	mVersionTo = "";
	mVersionToDescriptionURL = "";
