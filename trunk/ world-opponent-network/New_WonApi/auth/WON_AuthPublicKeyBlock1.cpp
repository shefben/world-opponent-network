...
WON_AuthPublicKeyBlock1::WON_AuthPublicKeyBlock1() :
	...
	mItrP(NULL)
{
			MessageBox(NULL, "WON_AuthPublicKeyBlock1", "1", MB_OK);
...
WON_AuthPublicKeyBlock1::WON_AuthPublicKeyBlock1(const unsigned char* theRawP,
	...
	mItrP(NULL)
{
		MessageBox(NULL, "WON_AuthPublicKeyBlock1", "2", MB_OK);
...
WON_AuthPublicKeyBlock1::WON_AuthPublicKeyBlock1(const WON_AuthPublicKeyBlock1& theBlockR) :
	...
	mItrP(NULL)
{
		MessageBox(NULL, "WON_AuthPublicKeyBlock1", "copy", MB_OK);
...
{
	MessageBox(NULL, "WON_AuthPublicKeyBlock1", "assign", MB_OK);
	if (this != &theBlockR)
	{
...
{
MessageBox(NULL, "WON_AuthPublicKeyBlock1", "verify", MB_OK);
...
{
	MessageBox(NULL, "WON_AuthPublicKeyBlock1", "getblockid", MB_OK);
...
{
	MessageBox(NULL, "WON_AuthPublicKeyBlock1", "getkeys", MB_OK);
...
{
	MessageBox(NULL, "WON_AuthPublicKeyBlock1", "first key", MB_OK);
	*mItrP = mBlockP->KeyList().begin();
	return GetNextKey();
}
