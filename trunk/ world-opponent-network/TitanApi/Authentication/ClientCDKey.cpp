...
//#include "common/RegKey.h"	// WON 3/21/00
#include "common/CRC16.h"

#ifdef WIN32					// WON 3/21/00
...
//	using WONCommon::RegKey;	// WON 3/21/00
...
//	const string        REG_CDKEY_PATH(REG_CONST::REG_WON_KEY_NAME + REG_CONST::REG_BACKSLASH + "CDKeys");	// WON 3/21/00
...
ClientCDKey::ClientCDKey(const string& theProductR, bool storeInHKeyCurUser) :	// WON 3/21/00
	...
	mStrKey(),
	mBinKey(),
	mStoreInHKeyCurUser(storeInHKeyCurUser)	// WON 3/21/00
{}
...
ClientCDKey::ClientCDKey(const ClientCDKey& theKeyR) :
	...
	mStoreInHKeyCurUser(theKeyR.mStoreInHKeyCurUser)	// WON 3/21/00
{}
...
ClientCDKey::Load()
{
	...
	// Open registry key
	RegKey aRegKey(REG_CDKEY_PATH, mStoreInHKeyCurUser?HKEY_CURRENT_USER:HKEY_LOCAL_MACHINE);	// WON 3/21/00
	if (! aRegKey.IsOpen())
	{
